...
class CarEditMakes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: "",
    ...
    componentDidMount() {
        CarMakeGetEdit(this.props.editLeave)
            .then((res) => {
                                ...
                                <div className="modal-body mx-5">
                                    <Formik
                                        ...
                                        onSubmit={(values, onSubmitProps) => {
                                            ...
                                            PatchCarMakeData(fd, this.props.editLeave).then(
                                                (res) => {
                                                    if (res.data.Status) {
