...
import { updateGarage } from '../../api/PATCH';
...
class EditGarage extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({ filename: this.props.data.profile_image })
    }
    componentWillUnmount() {
        // console.log("cool__componentWillUnmount");
        this.setState({ data: {} })
    }
    showModal() {
    ...
    render() {
        // console.log("this.props.data", this.state.data, this.props.id);
        return (
            <Translation>{
                (t, { i18n }) =>
                    <div
                                ...
                                <div className="modal-body mx-5">
                                    <Formik
                                        initialValues={{
                                            ...
                                            mobile_no: this.state.data.mobile_no,
                                        ...
                                        onSubmit={(values, onSubmitProps) => {
                                            ...
                                            if (this.state.imgfile) {
                                                ...
                                                fd.set("profile_image", this.state.filename)
                                            }

                                            updateGarage(this.props.id, fd).then(
                                                res => {
                                                    this.showLoading()
                                                    if (res.data.Status) {
                                                        console.log(res);
